...
class Program
{
    ...
    static void PrintUsage()
    {
        ...
        Console.WriteLine("                        信頼区間を計算（パラメトリック・ブートストラップ）");
        Console.WriteLine("                        （水準は設定ファイルの Bootstrap.ConfidenceLevel、デフォルト 95%）");
        ...
        Console.WriteLine("  --holdout-days N, --holdout N");
        Console.WriteLine("                        末尾N日をホールドアウト検証に使用");
        ...
        Console.WriteLine("                        （残差分析、自己相関検定、正規性検定、Poisson整合性診断、χ²・KS・CvM検定）");
