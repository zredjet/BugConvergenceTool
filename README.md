...
> **注意**: 変化点 τ は AIC の前提（正則条件）を満たさないため、AIC/AICc は変化点モデルを過大に有利にする傾向があります。変化点のない合成データでも、指数型+変化点が ΔAICc < 2 の僅差で選ばれることがあります。変化点モデルが推奨された場合は、変化点なしのモデルとの ΔAICc と、変化点の尤度比検定の結果を確認してください。
